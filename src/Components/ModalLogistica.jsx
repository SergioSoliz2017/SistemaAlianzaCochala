...
export default function ModalLogistica({ estado, cambiarEstado}) {
          ...
          .then(
            function (response) {
              Swal.fire({
                position: "center",
                icon: "success",
                title: "Encargado de logistica creado con exito.",
